...
<<<<<<< HEAD
		return BaseObject.extend("zapp.model.ListSelector", {
			 ...
			 * @return {zapp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
			 ...
			 * @return {zapp.model.ListSelector} the list selector object for method chaining
=======
		return BaseObject.extend("zemployee.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zemployee.model.ListSelector
			 */
			 ...
			 * @param {function} fnFunction the function to be executed when the list fires a selection change event
			 * @param {function} oListener the listener object
			 * @return {zemployee.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
			attachListSelectionChange : function (fnFunction, oListener) {
				this._oWhenListHasBeenSet.then(function () {
